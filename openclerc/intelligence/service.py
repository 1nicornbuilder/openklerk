...
from openclerc.intelligence.prompts import (
...
def get_openklerk_service(backend: str = "google", **kwargs) -> "OpenKlerkService":
    ...
    from openclerc.intelligence.backends import get_backend
...
class OpenKlerkService:
    ...
    async def analyze_screenshot(
        ...
        from openclerc.intelligence.prompts import SCREENSHOT_ANALYSIS_PROMPT
