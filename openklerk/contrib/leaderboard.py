...
REPO = "NeverMissAFiling/openklerk"
...
async def show_leaderboard(token: Optional[str] = None):
    ...
    async with httpx.AsyncClient() as client:
        ...
        if tree_resp.status_code == 200:
            ...
            filer_files = [
                ...
                if f["path"].startswith("openklerk/filers/") and f["path"].endswith(".py")
    ...
    # Display
    table = Table(title=f"OpenKlerk Contributors ({filer_count} filers)")
