...
def get_backend(name: str, **kwargs) -> LLMBackend:
    ...
    name = name.lower()
    if name == "google":
        from openklerk.intelligence.backends.google import GoogleVertexBackend
        return GoogleVertexBackend(**kwargs)
    elif name == "anthropic":
        from openklerk.intelligence.backends.anthropic import AnthropicBackend
        return AnthropicBackend(**kwargs)
    elif name == "openai":
        from openklerk.intelligence.backends.openai import OpenAIBackend
        return OpenAIBackend(**kwargs)
    elif name == "ollama":
        from openklerk.intelligence.backends.ollama import OllamaBackend
